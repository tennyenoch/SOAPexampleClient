...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements org.soap.example.HelloWorldService {
    ...
    public org.soap.example.HelloWorld getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public org.soap.example.HelloWorld getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.soap.example.HelloWorldSoapBindingStub _stub = new org.soap.example.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.soap.example.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                org.soap.example.HelloWorldSoapBindingStub _stub = new org.soap.example.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://example.soap.org", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://example.soap.org", "HelloWorld"));
        }
