...
<jsp:useBean id="sampleHelloWorldProxyid" scope="session" class="org.soap.example.HelloWorldProxy" />
<%
...
case 10:
        gotMethod = true;
        org.soap.example.HelloWorld getHelloWorld10mtemp = sampleHelloWorldProxyid.getHelloWorld();
